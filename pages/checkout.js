...
export default function CheckoutPage() {
  ...
  useEffect(() => {
    ...
    fetch('/api/product?ids='+uniqIds.join(','))
  ...
  return (
    <Layout>
      ...
      <form action="/api/checkout" method="POST">
        ...
        <button type="submit" className="bg-yellow-500 px-5 py-2 rounded-xl font-bold text-white w-full my-4 shadow-emerald-300 shadow-lg">Pay ${total}</button>
      </form>
    </Layout>
  );
}
